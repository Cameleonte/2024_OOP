...
class Television(HDMIConnect, RCAConnect, PowerConnect):
...
class DVDPlayer(HDMIConnect, PowerConnect):
...
class GameConsole(HDMIConnect, EthernetConnect, PowerConnect):
    def connect_to_tv(self, television):
        self.connect_to_device_via_hdmi_cable(television)
...
class Router(EthernetConnect, PowerConnect):
    def connect_to_tv(self, television):
